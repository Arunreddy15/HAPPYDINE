  ...
  return (
    <div className="Login-container reset-pwd">
      <div className="Inner-container">
        <div className="login-form">
          ...
          <div className="userpass_con">
            ...
            <button type="button" onClick={toggle} disabled>
              {isOn ? (
                <LuEyeClosed size={22} className="icons" />
              ) : (
                <LuEye size={22} className="icons" />
              )}
            </button>
          </div>
          <div className="userpass_con">
          ...
          <button className="submitbtn" onClick={ResetPassword}>
            Submit
          </button>
        ...
        <img
          src="https://i.postimg.cc/fbm65fXv/reset-p.jpg"
          className="side-image reset-pwd-img"
        />
      </div>
    </div>
  );
